window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var __toESM = (mod, isNodeMode, target) => (target = mod != null ? __create(__getProtoOf(mod)) : {}, __copyProps(isNodeMode || !mod || !mod.__esModule || !__hasOwnProp$1.call(mod, "default") ? __defProp$1(target, "default", {
			value: mod,
			enumerable: true
		}) : target, mod));
		//#endregion
		...
		*/
		function StatusRow({ label, value, tone }) {
			return (0, react.createElement)("div", { style: {
				...
				key: "label",
				style: { color: "var(--dsw-alias-label-secondary, #8b98a5)" }
			}, label), (0, react.createElement)("span", {
				key: "value",
				style: {
					color: tone ?? "var(--dsw-alias-label-primary, #e7e9ea)",
					wordBreak: "break-all",
					textAlign: "right"
				}
			}, value)]);
		...
		function RemotePanel() {
			...
			const issue = async () => {
				setError(null);
				try {
					const payload = await (await fetch("/api/pair/issue", {
						method: "POST",
						body: "{}"
					})).json();
			...
			const tunnelTone = status?.tunnel?.state === "running" ? "#00ba7c" : status?.tunnel?.state === "failed" ? "#e5484d" : void 0;
			return (0, react.createElement)("div", { style: {
				padding: "0 16px 24px",
				overflowY: "auto",
				...
				(0, react.createElement)(StatusRow, {
					key: "phase",
					label: "配对状态",
					value: {
				...
				(0, react.createElement)(StatusRow, {
					key: "devices",
					label: "设备",
					value: `${status?.onlineCount ?? 0} 在线 / ${status?.deviceCount ?? 0} 已配对`
				}),
				(0, react.createElement)(StatusRow, {
					key: "tunnel",
					label: "隧道",
				...
				}, "生成配对二维码"), (0, react.createElement)("button", {
					key: "stop",
					type: "button",
					onClick: () => void stop(),
					style: actionButton("transparent", "#e5484d")
				}, "停止配对")]),
				qrUrl ? (0, react.createElement)("div", {
					key: "qr",
					style: {
						background: "#ffffff",
						borderRadius: 12,
				...
				}, [(0, react.createElement)(QRCodeSVG, {
					key: "svg",
					value: qrUrl,
					size: 220,
					level: "M"
				...
				status?.publicUrl ? (0, react.createElement)(StatusRow, {
					key: "public",
					label: "公网入口",
		...
		//#endregion
		//#region src/client/RemoteLauncher.tsx
		/**
		...
		*/
		...
		function RemoteFootButton({ wide }) {
			...
			}, "远"), wide ? (0, react.createElement)("span", { key: "label" }, "远程控制") : null]);
		}
		...
		function RemoteOverlay() {
			...
			]), (0, react.createElement)(RemotePanel, { key: "panel" })]);
		}
		function registerRemoteLauncher(ctx) {
