...
function apply(ctx, config = {}) {
	...
	const tunnel = new TunnelMuxTunnelManager(createTunnelMuxHttpClient(resolved.tunnelmuxBaseUrl, resolved.tunnelmuxApiToken || void 0), {
		tunnelId: "dsh-remote",
...
//#endregion
export { Config, REMOTE_SETTINGS_NAMESPACE, apply, inject, name };
