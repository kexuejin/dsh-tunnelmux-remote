...
//#endregion
//#region src/mobile-app/index.tsx
...
async function rpc(method, payload) {
	...
	if (!envelope.result?.ok) throw new Error(envelope.result?.error?.message ?? `rpc ${method} failed`);
...
function App() {
	...
	const [unpaired, setUnpaired] = (0, import_react.useState)(false);
	const [enterToSend, setEnterToSend] = (0, import_react.useState)(true);
	const [title, setTitle] = (0, import_react.useState)("");
	const [message, setMessage] = (0, import_react.useState)("");
	const messagesEndRef = (0, import_react.useRef)(null);
	const loadPreferences = async () => {
		try {
			const value = await rpc("mobile.preferences");
	...
	const loadSessions = async (cursor) => {
		...
		setError(null);
		try {
			const value = await rpc("session.list", cursor ? { cursor } : {});
			setSessions((prev) => cursor ? [...prev, ...value.items] : value.items);
			setNextCursor(value.hasMore ? value.nextCursor : void 0);
		} catch (err) {
	...
	if (unpaired) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		style: {
			padding: 24,
			fontFamily: "system-ui, sans-serif"
		},
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { children: "未配对" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "请先在电脑上打开 DSH，扫码配对后刷新本页。" }),
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: "新建会话" }),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: "会话列表" }),
				sessions.length === 0 && !loading && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "暂无会话" }),
				sessions.map((session) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					style: styles.row,
					children: session.title ?? session.sessionId
				}, session.sessionId)),
				loading && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "加载中…" }),
				nextCursor !== void 0 && !loading && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					style: styles.button,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: "发消息" }),
...
if (root) (0, import_client.createRoot)(root).render(import_react.createElement(App));
//#endregion
